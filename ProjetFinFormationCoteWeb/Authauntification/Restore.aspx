<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Restore.aspx.cs" Inherits="ProjetFinFormationCoteWeb.Views.Authauntification.Restore" %>
			...
			<div class="wrap-login100">
				...
				<form class="login100-form validate-form" runat="server">
					<div class="login100-form-title js-tilt " style="border: none">
						...
						<img alt="" class="auto-style1" src="Images/man_rest.png" /></div>
                    ...
                    <div class="wrap-input100 validate-input" data-validate = "Mot de passe requis">
						...
						<asp:TextBox ID="txtPw" name="pass" Enabled="False" type="text" value="Mot de passe Récupérer" CssClass="input100"  runat="server"></asp:TextBox>
						<span class="focus-input100"></span>
						<span class="symbol-input100">
					...
					<div class="container-login100-form-btn">
							...
							<asp:Button ID="btnRestore" CssClass="login100-form-btn" runat="server" Text="Récupérer" OnClick="btnRestore_Click"  />
