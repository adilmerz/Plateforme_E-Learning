<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/Admin.Master" AutoEventWireup="true" CodeBehind="TDI.aspx.cs" Inherits="ProjetFinFormationCoteWeb.Pages.TDI" %>
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <form id="formTdi" runat="server">
   <h1 class="title text-xl-left ">Modules : Techniques de Développement Informatique [ TDI ] </h1> 
    <br/>
   <div class="row  ">
       <asp:Repeater ID="RepeaterModuleTDI" runat="server" OnItemCommand="RepeaterModuleTDI_ItemCommand">
       <ItemTemplate>
